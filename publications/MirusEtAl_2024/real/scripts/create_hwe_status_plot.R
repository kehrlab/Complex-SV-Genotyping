# Tim Mirus
# 
# Plot an overview of the Hardy-Weinberg Equilibrium of all variants within
# the unrelated samples of the Polaris diversity cohort for all algorithms.
# HWE is judged by the Chi^2-value between observed and expected genotype counts.
...
CairoPDF("plots/hwe_status.pdf", width = 20, height = 5, version = "1.5")
plot(p)
dev.off()
